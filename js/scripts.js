...
var verbs = ['can never purify', 'will devour', 'destroyed', 'will engulf', 'could never imagine', 'conquered', 'mangled', 'defenestrated', 'incurred the wrath of', 'grasped', 'desperately craved', 'choked the life out of', 'fucked', 'repeatedly licked', 'could not fathom', 'did not want', 'rejected', 'punctured', 'embraced', 'ignited', 'ruined', 'flicked spiders at', 'celebrated', 'sliced up', 'left a trail of blood across', 'pulverized', 'tweeked the nipple of', 'found fault with', 'dealt a fatal blow to', 'ended', 'fattened', 'infested', 'infected', 'slowly oozed', 'lurked just below', 'will soon crush', 'grew tired of', 'tore apart', 'plundered', 'ate', 'flapped ineffectually at', 'collected', 'never escaped from', 'will never be free of', 'groped blindly at', 'domesticated', 'enslaved', 'plagiarized', 'redefined', 'whittled away at', 'killed', 'gleefully regurgitated', 'abandoned', 'refused to consider', 'will decide the fate of', 'vehemently contradicted', 'drilled a hole in', 'vomited out', 'struggled to comprehend', 'did not forsee', 'snuffed out', 'gave rise to', 'could not justify', 'will rain down fire upon', 'will always crave', 'created', 'will outlive', 'will not tolerate', 'will feast upon', 'pillaged', 'rained fire and ash down upon', 'grew weary of', 'will forever haunt the darkness within'];

var objects = ['the Earth', 'everything', 'a baby', 'the body of Christ', 'the Hermetic Order of the Golden Dawn', 'all the blood', 'a murder of crows', 'hope', 'timidity', 'all the morons', 'dreams', 'capitalism', 'silence', 'the depths of despair', 'a judgemental nun', 'the void', 'the jabbering masses', 'fashion', 'the plague', 'a stormy sea', 'the abyss', 'morality', 'dogma', 'the eternal night', 'ignorance', 'all of human suffering', 'parties on the weekend', 'a comfortable life', 'complacency', 'the tedious sleepwalkers', 'flesh sacks', 'poison', 'materialism', 'the hedonistic rats', 'an unexamined life', 'faith', "children's tears", 'fear itself', 'all that could have been', 'fascists', 'the government', 'polite society', 'all the fuckers', 'that fucking fucker', 'one lonely cunt', 'the pain of existence', 'heroism', 'a gnawing sense of loss', 'monkeys', 'the restless ghost of Lovecraft', 'an engorged ego', 'the fourth dimension', 'the slaves', 'the masters', 'conformity', 'blasphemy', 'abstract entities', 'sodomy', 'the ultimate sacrifice', 'the living', 'the machines', 'parasites', 'everyone', 'the singularity', 'the dead', 'the concept of money', 'nothing and everything', 'the cave', 'an unquenchable fire', 'the Black Iron Prison', 'dark satanic mills', 'the herd', 'a drug-induced nightmare', 'our vision of reality', 'the lunatic in the closet'];
